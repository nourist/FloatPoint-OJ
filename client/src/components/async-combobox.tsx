      ...
      <div className="relative w-full">
        <PopoverTrigger asChild>
          <Button
            variant="outline"
            role="combobox"
            className="w-full justify-between bg-transparent font-normal pr-8" // chừa chỗ bên phải
          >
        ...
        {value && (
          <X
            className="absolute right-3 top-1/2 h-4 w-4 -translate-y-1/2 cursor-pointer opacity-60 hover:opacity-100"
            onClick={(e) => {
      ...
      <PopoverContent className="w-full p-0">
        <Command shouldFilter={false}>
          <CommandInput
            ...
            value={search}
            onValueChange={(val) => set_search(val)}
          />
          <CommandList>
            ...
            <CommandGroup>
              ...
              {has_more && !isValidating && (
                <div
                  className="cursor-pointer p-2 text-center text-sm text-blue-500"
