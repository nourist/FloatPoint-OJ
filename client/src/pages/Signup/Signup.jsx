		...
		<div className="w-full py-10 flex items-center justify-center">
			...
			>
				<div className="p-8 space-y-6">
					<h2 className="text-3xl font-bold mb-6 text-center bg-gradient-to-r from-sky-400 to-blue-400 text-transparent bg-clip-text">Create Account</h2>
					<Input
					...
					<Button className="h-9 w-full from-sky-400 to-blue-500 bg-gradient-to-r !text-white font-bold ">Signup</Button>
				</div>
