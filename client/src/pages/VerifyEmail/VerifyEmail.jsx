					...
					<OtpInput
						...
						renderInput={(props) => (
							<input
								...
								className="dark:bg-opacity-40 mx-auto rounded-md border border-neutral-300 text-center text-lg text-gray-800 caret-sky-400 transition-all duration-200 outline-none focus:border-sky-400 focus:ring-1 focus:ring-sky-400 dark:border-none dark:bg-neutral-700 dark:text-gray-200 dark:focus:border-sky-400"
							/>
						)}
					/>
					<Button
