	...
	return (
		<div className="flex h-full w-full justify-center py-[10%] dark:bg-gray-900">
			<div className="text-center">
				...
				<h1 className="mt-4 text-5xl font-semibold tracking-tight text-balance text-gray-900 sm:text-7xl dark:text-gray-100">{t('title')}</h1>
				<p className="mt-6 text-lg font-medium text-pretty text-gray-500 sm:text-xl/8">{t('text')}</p>
				<Link
