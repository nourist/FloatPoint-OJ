	...
	return (
		<div className="h-full w-full px-16 py-8">
			<div className="rounded-md bg-white p-6 px-10 dark:bg-neutral-800">
				...
				<h4 className="mt-10 block text-sm/6 font-medium text-gray-900 capitalize dark:text-gray-50">{t('fullname')}</h4>
				<Input
				...
				></Input>
				<h4 className="mt-10 block text-sm/6 font-medium text-gray-900 capitalize dark:text-gray-50">{t('about')}</h4>
				<textarea
					rows="3"
					className="dark:bg-opacity-40 block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-sky-500 sm:text-sm/6 dark:bg-neutral-700 dark:text-gray-100 dark:outline-neutral-700/40"
					value={userValue.bio}
				...
				<h4 className="mt-10 block text-sm/6 font-medium text-gray-900 capitalize dark:text-gray-50">{t('avatar')}</h4>
				<div className="mt-2 flex items-center gap-4">
					<UserAvatar user={user} className="size-12"></UserAvatar>
					<Link
						to={routesConfig.avatarChange}
						className="rounded-sm bg-white px-2.5 py-1.5 text-sm font-semibold text-gray-900 capitalize shadow-xs ring-1 ring-gray-300 ring-inset hover:bg-gray-50 dark:bg-neutral-700 dark:text-white dark:ring-0"
					>
						{t('change')}
					</Link>
				</div>
				...
				<h4 className="mt-10 mb-2 block text-sm/6 font-medium text-gray-900 capitalize dark:text-gray-50">{t('default-language')}</h4>
				<Select
				...
				<h4 className="mt-10 mb-2 block text-sm/6 font-medium text-gray-900 capitalize dark:text-gray-50">{t('language')}</h4>
				<Select
					triggerClassname="!bg-white border border-gray-300"
				...
				></Select>
				<p className="mt-3 mb-2 text-sm/6 text-gray-600 dark:text-gray-300">{t('language-msg')}</p>
				<h4 className="mt-10 mb-2 block text-sm/6 font-medium text-gray-900 capitalize dark:text-gray-50">{t('theme')}</h4>
				...
				<div className="flex space-x-4">
					...
					<label htmlFor="system" className="hover:cursor-pointer">
						<div className="relative w-44">
							...
							<div className="absolute top-0 left-1/2 w-1/2 overflow-hidden">
				...
				<h4 className="mt-10 mb-2 block text-sm/6 font-medium text-gray-900 capitalize dark:text-gray-50">{t('change-password')}</h4>
				<button
					onClick={() => {
						forgotPassword(user.email);
					}}
					className="!bg-opacity-10 inline-flex items-center gap-2 rounded-sm bg-white px-3 py-2 text-sm text-gray-900 capitalize shadow-xs ring-1 ring-gray-300 ring-inset hover:bg-red-500 hover:text-red-500 hover:ring-red-500 dark:text-white"
				>
					{t('change-password')}
