...
export class RemoveOleStatus1754967515328 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."submission_results_status_enum" AS ENUM('ACCEPTED', 'WRONG_ANSWER', 'RUNTIME_ERROR', 'TIME_LIMIT_EXCEEDED', 'MEMORY_LIMIT_EXCEEDED')`);
        await queryRunner.query(`ALTER TABLE "submission_results" ALTER COLUMN "status" TYPE "public"."submission_results_status_enum" USING "status"::"text"::"public"."submission_results_status_enum"`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."submissions_status_enum" AS ENUM('PENDING', 'JUDGING', 'ACCEPTED', 'WRONG_ANSWER', 'RUNTIME_ERROR', 'TIME_LIMIT_EXCEEDED', 'MEMORY_LIMIT_EXCEEDED', 'COMPILATION_ERROR', 'INTERNAL_ERROR')`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."submissions_status_enum_old" AS ENUM('PENDING', 'JUDGING', 'ACCEPTED', 'WRONG_ANSWER', 'RUNTIME_ERROR', 'OUTPUT_LIMIT_EXCEEDED', 'TIME_LIMIT_EXCEEDED', 'MEMORY_LIMIT_EXCEEDED', 'COMPILATION_ERROR', 'INTERNAL_ERROR')`);
        await queryRunner.query(`ALTER TABLE "submissions" ALTER COLUMN "status" DROP DEFAULT`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."submission_results_status_enum_old" AS ENUM('ACCEPTED', 'WRONG_ANSWER', 'RUNTIME_ERROR', 'OUTPUT_LIMIT_EXCEEDED', 'TIME_LIMIT_EXCEEDED', 'MEMORY_LIMIT_EXCEEDED')`);
        await queryRunner.query(`ALTER TABLE "submission_results" ALTER COLUMN "status" TYPE "public"."submission_results_status_enum_old" USING "status"::"text"::"public"."submission_results_status_enum_old"`);
