...
import { Breadcrumbs, IconButton, Menu, MenuHandler, MenuList, MenuItem } from '@material-tailwind/react';
...
const Header = () => {
	...
	return (
		<div
			data-scroll={scroll}
			className="shadow-shadow-color/3 data-[scroll=true]:bg-base-100 fixed top-3 left-[274px] flex h-[78px] w-[calc(100%-298px)] items-center gap-1 rounded-md px-5 py-4 transition-all duration-200 ease-in-out data-[scroll=true]:shadow-xl"
		>
			<div>
			...
			<Menu>
				<MenuHandler>
					<IconButton variant="text" className="hover:bg-base-300 ml-auto size-[38px] cursor-pointer rounded-full">
