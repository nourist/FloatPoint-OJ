	...
	return (
		<>
			...
			<div className="bg-base-100 shadow-clg shadow-shadow-color/3 rounded-xl p-8">
				...
				<FullOutlineInput value={id} onChange={(e) => setId(e.target.value)} className="mt-2 w-2/6 min-w-52" placeholder={t('contest-id')} />
				...
				<FullOutlineInput value={title} onChange={(e) => setTitle(e.target.value)} className="mt-2 w-1/2 min-w-60" placeholder={t('contest-title')} />
